...
function templateRefy(htmlRoot, attribute, search, templateBodyFunc, templateRefsToAdd) {
  ...
  htmlRoot.childNodes.forEach((element, i)  => {
    ...
    if (htmlRoot.children[i] && htmlRoot.children[i].documentElement.hasAttribute instanceof Function && htmlRoot.children[i].documentElement.hasAttribute(attribute)) {
