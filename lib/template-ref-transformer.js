...
function templateRefy(htmlRoot, attribute, search, templateBodyFunc, templateRefsToAdd) {
  ...
  htmlRoot.childNodes.forEach((element, i)  => {
    console.log(htmlRoot.children[i].documentElement)
    if (htmlRoot.children[i].documentElement && htmlRoot.children[i].documentElement.hasAttribute instanceof Function && htmlRoot.children[i].documentElement.hasAttribute(attribute)) {
